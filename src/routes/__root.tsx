...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Anvaya — Civic Infrastructure Operations" },
      {
        name: "description",
        content:
          "Anvaya is a civic operations platform for utilities, roads, work verification and citizen complaints.",
      },
      { property: "og:title", content: "Anvaya — Civic Infrastructure Operations" },
      {
